...
trayerOpts="--edge top --align right --SetDockType true --SetPartialStrut true --expand true --height 42 --transparent true --tint 0x102235 --alpha 0 --padding 0 --widthtype pixel"
